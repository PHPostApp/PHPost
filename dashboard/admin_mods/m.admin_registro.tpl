...
<div id="res" class="boxy-content">
	...
	<form action="" method="post" autocomplete="off">
      <fieldset>
		  	...
		  	<dl>
            <dt><label for="pkey">reCaptcha p&uacute;blica v3</label><br /><span>Clave p&uacute;blica de <a targe="_blank" href="https://www.google.com/recaptcha/admin">reCatpcha</a>.</span></dt>
            <dd><input type="text" id="pkey" name="pkey" value="{$tsConfig.pkey}" /></dd>
         </dl>
         <dl>
            <dt><label for="skey">reCaptcha secreta v3</label><br /><span>Clave privada de <a targe="_blank" href="https://www.google.com/recaptcha/admin">reCatpcha</a>.</span></dt>
