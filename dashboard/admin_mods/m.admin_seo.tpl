...
<div id="res" class="boxy-content">
   <form action="" method="post" autocomplete="off">
      <fieldset>
         ...
         <dl>
            <dt><label for="images">Otros iconos:</label><br><small>16x16, 32x32, 64x64, etc</small><br><button type="button" class="mBtn btnOk" onclick="favs.add()">Añadir</button></dt>
            <dd id="addFavs">
         ...
         <p><input type="submit" value="Guardar Cambios" class="mBtn btnOk" /></p>
      </fieldset>
   </form>
</div>