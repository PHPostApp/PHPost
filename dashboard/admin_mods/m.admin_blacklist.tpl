				...
				<tbody>
					...
					<tr id="block_{$b.id}">
						...
						<td class="admin_actions">
							<a href="{$tsConfig.url}/admin/blacklist?act=editar&id={$b.id}"><img src="{$tsConfig.assets}/images/icons/editar.png" title="Editar" /></a>
							<a href="#" onclick="admin.blacklist.borrar({$b.id}); return false"><img src="{$tsConfig.assets}/images/icons/close.png" title="Eliminar"/></a>
						</td>
					</tr>
					{/foreach}
				</tbody>
