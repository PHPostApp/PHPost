...
<div id="res" class="boxy-content" style="position:relative">
	{if !$tsAct}
		...
		{else}
			<table class="admin_table" width="100%" align="center">
				<thead>
					<th>Nick actual</th>
					<th>Nuevo nick</th>
					<th>Fecha</th>
					...
					{foreach from=$tsAdminNicks.data item=n}
						<tr id="nick_{$n.id}">
							...
							<td class="admin_actions">
								<a href="#" onclick="admin.nicks.accion('{$n.id}', 'aprobar'); return false"><img src="{$tsConfig.assets}/images/icons/power_on.png" title="Aprobar"/></a>
								<a href="#" onclick="admin.nicks.accion('{$n.id}', 'denegar'); return false"><img src="{$tsConfig.assets}/images/icons/power_off.png" title="Denegar"/></a>
							</td>
						</tr>
					{/foreach}
				</tbody>
		...
		{/if}
		<a href="{$tsConfig.url}/admin/nicks?act=realizados" class="mBtn btnOk">Ver decisiones tomadas</a>
