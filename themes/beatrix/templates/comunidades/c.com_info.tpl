    ...
    <div class="vci_right floatL">
        ...
        <div class="clearfix vci_bottom">
        	<div class="floatL">
                ...
                <a href="{if $tsUser->is_member}javascript:com.unirme();{else}{$tsConfig.url}/registro{/if}" class="action_comunidad input_button" style="padding:10px 11px;{if $tsCom.es_miembro}display:none;{/if}">Unirme</a>
                {if $tsUser->is_member}
