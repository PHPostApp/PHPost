<div class="com_tema_autor clearfix">
    ...
    <div class="com_box_body clearfix">
        ...
        <div class="cta_detalles floatL">
            ...
            <div class="clearfix">
                {if !$tsUser->is_member}
                <a href="{$tsConfig.url}/registro" class="input_button"><i class="com_icon icon_eye"></i>Seguir Usuario</a>
...
<div class="com_new_box">
    ...
    <div class="com_box_body clearfix">
        ...
        {else}
            <a href="{$tsConfig.url}/comunidades/{$tsCom.c_nombre_corto}/editar-tema/{$tsTema.t_id}/" class="input_button">Editar</a>
...
<div class="com_new_box">
    ...
    <div class="com_box_body clearfix">
        ...
        <div class="com_list_element"><a class="cle_autor" href="{$tsConfig.url}/perfil/{$r.user_name}">{$r.user_name}</a><a class="cle_title" href="{$tsConfig.url}/comunidades/{$tsCom.c_nombre_corto}/{$r.t_id}/{$r.t_titulo|seo}.html#coment_id_{$r.r_id}">{$r.t_titulo|truncate:30}</a></div>
        {/foreach}
        {else}
...
<small><i class="com_icon icon_denuncia" style="vertical-align:top;margin-right:1px;opacity: 0.5;"></i><a href="#" onclick="denuncia.nueva('tema',{$tsTema.t_id}, '{$tsTema.t_titulo}', '{$tsAutor.user_name}'); return false;">Denunciar Tema</a> - <a href="{$tsConfig.url}/comunidades/{$tsCom.c_nombre_corto}/mod-history/">Historial</a></small>
