                	<div class="post-autor vcard">
                        ...
                        <div class="box_cuerpo">
                            ...
                            {if $tsAutor.user_id != $tsUser->uid}<a href="{if !$tsUser->is_member}{$tsConfig.url}/regsitro{else}mensaje.nuevo('{$tsAutor.user_name}','','','');return false{/if}"><img title="Enviar mensaje privado" src="{$tsConfig.images}/icon-mensajes-recibidos.gif"/></a>{/if}
                            {if !$tsUser->is_member}
                            <hr class="divider"/>
