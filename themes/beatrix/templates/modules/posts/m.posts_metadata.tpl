                    	...
                    	<div style="padding: 12px">
                            ...
                            <div class="post-acciones">
                            	<ul>
									...
									<li><a href="{if !$tsUser->is_member}{$tsConfig.url}/registro{else}add_favoritos(); return false{/if}" class="btn_g"><span class="icons agregar_favoritos">Agregar a Favoritos</span></a></li>
