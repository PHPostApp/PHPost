                ...
                <div class="bajo" style="margin-top:5px">
                    <div class="comments">
                        ...
                        {else}
                        <div class="emptyData">Para poder comentar necesitas estar <a href="{$tsConfig.url}/registro">Registrado.</a> O.. ya tienes usuario? <a href="{$tsConfig.url}/login">Logueate!</a></div>
                        {/if}
                    </div>
                </div>
                </div>
