						...
						<div class="col-lg-6">
							...
							*}
							<div class="copyright-text" id="pp_copyright">
								<p>Copyright &copy; <a href="{$tsConfig.url}/" rel="internal"><strong>{$tsConfig.titulo}</strong></a> 2023-{$smarty.now|date_format:'Y'}. Todos los derechos reservado</p>
							</div>
						</div>
						<div class="col-lg-6">
...
{phpost js=["acciones.js", "app.js"] scriptLine=true}
<script>
