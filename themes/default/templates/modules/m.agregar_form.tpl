			...
			<ul class="clearbeta">
				...
				<li class="special-right clearbeta">
					...
					<div class="option clearbeta">  
						<input type="checkbox" tabindex="6" name="privado" id="privado" class="floatL"{if $tsDraft.b_private == 1} checked{/if} />
						<p class="floatL">
					...
					<div class="option clearbeta">  
						<input type="checkbox" tabindex="7" name="sin_comentarios" id="sin_comentarios" class="floatL"{if $tsDraft.b_block_comments == 1} checked{/if}>
						<p class="floatL">
					...
					{if $tsUser->is_admod == 1}
					 	<div class="option clearbeta">  
						  	<input type="checkbox" tabindex="9" name="patrocinado" id="patrocinado" class="floatL"{if $tsDraft.b_sponsored == 1} checked{/if} >
						  	<p class="floatL">
