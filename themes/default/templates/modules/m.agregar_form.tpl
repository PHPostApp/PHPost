		...
		<form action="{$tsConfig.url}/agregar.php{if $tsAction == 'editar'}?action=editar&pid={$tsPid}{/if}" method="post" name="newpost" autocomplete="off">
			...
			<ul class="clearbeta">
				<li>
					...
					<input type="text" tabindex="1" name="title" maxlength="60" size="60" class="text-inp required" value="{$tsDraft.b_title}" style="width:760px"/>
					<div id="repost"></div>
				</li>
				<li>
					<a name="post"></a>
					...
					<span style="display: none;" class="errormsg"></span>
					<textarea id="markItUp" name="body" tabindex="2" style="min-height:400px;" class="text-inp required">{$tsDraft.b_body}</textarea>
				</li>
				<li>
					<label>Tags</label>
					<span style="display: none;" class="errormsg"></span>
				...
				<li class="special-left clearbeta">
					...
					<span style="display: none;" class="errormsg"></span>
					<select class="text-inp agregar required" tabindex="5" size="9" style="width:300px; float:left" size="{$tsConfig.categorias.ncats}" name="category">
