                	<div class="post-autor vcard">
                        ...
                        <div class="box_cuerpo">
                            ...
                            <img src="{$tsConfig.assets}/images/icons/ran/{$tsAutor.rango.r_image}.png" title="{$tsAutor.rango.r_name}" />
                            <img src="{$tsConfig.assets}/images/icons/{if $tsAutor.user_sexo == 0}female{else}male{/if}.png" title="{if $tsAutor.user_sexo == 0}Mujer{else}Hombre{/if}" />
                            <img src="{$tsConfig.assets}/images/flags/{$tsAutor.pais.icon}.png" style="padding:2px" title="{$tsAutor.pais.name}" />
