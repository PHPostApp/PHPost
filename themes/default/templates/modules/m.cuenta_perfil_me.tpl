								...
								<fieldset>
                                    ...
                                    <div class="field">
                                        ...
                                        <img src="{$tsConfig.images}/icons/facebook.png" width="16" height="16" style="margin:5px; float:left" />
                                        ...
                                        <img src="{$tsConfig.images}/icons/twitter.png" width="16" height="16" style="margin:8px 5px 5px 160px; float:left" />
