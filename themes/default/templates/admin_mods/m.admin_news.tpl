										...
										<tbody>
											...
											<tr>
												...
												<td class="admin_actions">
													<a href="{$tsConfig.url}/admin/news/editar/{$n.not_id}"><img src="{$tsConfig.public}/images/icons/editar.png" title="Editar" /></a>
													...
													<a href="{$tsConfig.url}/admin/news?act=borrar&nid={$n.not_id}"><img src="{$tsConfig.public}/images/icons/close.png" title="Borrar" /></a>
												</td>
											</tr>
											{/foreach}
										</tbody>
