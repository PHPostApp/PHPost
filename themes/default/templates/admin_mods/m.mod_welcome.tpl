                                ...
                                <div id="res" class="boxy-content">
                                	<strong>Hola {$tsUser->nick}!</strong><br />Si est&aacute;s viendo esto significa que tienes el privilegio de ser moderador en <strong>{$tsConfig.titulo}</strong>, por favor lee el protocolo de moderadores para mantener todo en orden.
                                    <hr class="separator" />
                                    ...
                                    <ul id="reglas">
                                        ...
                                        <li>Borrar&aacute; todo post que haya sido denunciado o que detecte que no cumple con las reglas de <strong>{$tsConfig.titulo}</strong>.</li>
                                        ...
                                        <li>De no cumplirse cualquiera de estos puntos el moderador puede sufrir una pena que va desde tres d&iacute;as de suspensi&oacute;n hasta la p&eacute;rdida del cargo y/o expulsi&oacute;n definitiva de <strong>{$tsConfig.titulo}</strong>.</li>
                                    </ul>
