									...
									<tbody>
										...
										<tr id="sesion_{$s.session_id}">
											...
											<td class="admin_actions">
                                                <a href="#" onclick="admin.sesiones.borrar('{$s.session_id}'); return false"><img src="{$tsConfig.public}/images/icons/power_off.png" title="Cerrar sesi&oacute;n de {if $s.user_name}{$s.user_name}{else}este visitante{/if}"/></a>
											</td>
										</tr>
										{/foreach}
									</tbody>
