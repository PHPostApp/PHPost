                                        ...
                                        <tbody>
                                            ...
                                            <tr id="report_{$r.obj_id}">
                                                ...
                                                <td class="admin_actions">
                                                    ...
                                                    {if $tsUser->is_admod || $tsUser->permisos.modu}<a href="#" onclick="mod.reboot({$r.obj_id}, 'users', 'reboot', false); return false"><img src="{$tsConfig.public}/images/icons/close.png" title="Cancelar denuncias" /></a>{/if}
                                                </td>
                                            </tr>
                                            {/foreach}{else}
                                            <tr>
