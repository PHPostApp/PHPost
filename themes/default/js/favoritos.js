	...
	printResult: function(){
		...
		$.each(this.r, function(i, favorito) {
			...
			let h = `<tr id="favorito_id_${fav_id}">
				...
				<td><a id="change_status" href="" onclick="favoritos.eliminar(${fav_id}, this); return false;"><img src="${global_data.tema_images}/borrar.png" alt="borrar" title="Borrar Favorito" /></a></td>
			</tr>`;
			el.append(h);
		});
	},
			...
			success: function(h){
				switch(h.charAt(0)){
					...
					case '1': //OK
						...
						$(obj).children().attr({'src': global_data.img + '/reactivar.png',
																		'title': 'Reactivar',
																		'alt': 'reactivar'
																	});
			...
			success: function(h){
				switch(h.charAt(0)){
					...
					case '1': //OK
						...
						$(obj).children().attr({'src': global_data.img + '/borrar.png',
																		'title': 'Borrar',
																		'alt': 'Borrar'
																	});
