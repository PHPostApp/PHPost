 ...
 */
	if(!empty($_GET['post_id'])) {
		...
		if($tsPost['post_id'] > 0) {
			...
			// COMENTARIOS
			/*$tsComentarios = $tsPosts->getComentarios($tsPost['post_id']);
			$tsComentarios = array('num' => $tsComentarios['num'], 'data' => $tsComentarios['data']);
		...
		// ULTIMOS COMENTARIOS
		$smarty->assign("tsComentarios", $tsPosts->getLastComentarios());
		// TOP POSTS
