...
//			direction:			"ltr",
			...
			smileList: [
				// SMILES DEFAULT
				{title: "xd", img: '<img src="'+global_data.img+'/smiles/041.png">', bbcode:"xd"},
				{title: ":)", img: '<img src="'+global_data.img+'/smiles/001.png">', bbcode:":)"},
				{title: ":D", img: '<img src="'+global_data.img+'/smiles/002.png">', bbcode:":D"},
				{title: ";)", img: '<img src="'+global_data.img+'/smiles/003.gif">', bbcode:";)"},
				{title: ":O", img: '<img src="'+global_data.img+'/smiles/004.png">', bbcode:":O"},
				{title: "(H)", img: '<img src="'+global_data.img+'/smiles/006.png">', bbcode:"(H)"},
				{title: ":P", img: '<img src="'+global_data.img+'/smiles/104.png">', bbcode:":P"},
				{title: "8o|", img: '<img src="'+global_data.img+'/smiles/049.png">', bbcode:"8o|"},
				{title: ":S", img: '<img src="'+global_data.img+'/smiles/009.png">', bbcode:":S"},
				{title: ":$", img: '<img src="'+global_data.img+'/smiles/008.png">', bbcode:"_$"},
				{title: ":(", img: '<img src="'+global_data.img+'/smiles/010.png">', bbcode:":("},
				{title: ":'(", img: '<img src="'+global_data.img+'/smiles/011.gif">', bbcode:":'("},
				{title: ":|", img: '<img src="'+global_data.img+'/smiles/012.png">', bbcode:":|"},
				{title: "(6)", img: '<img src="'+global_data.img+'/smiles/013.png">', bbcode:"(6)"},
				{title: "8-|", img: '<img src="'+global_data.img+'/smiles/050.png">', bbcode:"8-|"},
				{title: ":-/", img: '<img src="'+global_data.img+'/smiles/083.png">', bbcode:":-/"},
				{title: "^o)", img: '<img src="'+global_data.img+'/smiles/051.png">', bbcode:"^o)"},
				{title: "(A)", img: '<img src="'+global_data.img+'/smiles/014.png">', bbcode:"(A)"},
				{title: ":[", img: '<img src="'+global_data.img+'/smiles/043.png">', bbcode:":["},
				{title: ":-#", img: '<img src="'+global_data.img+'/smiles/048.png">', bbcode:":-#"},
				{title: ":-*", img: '<img src="'+global_data.img+'/smiles/052.png">', bbcode:":-*"},
				{title: "+o(", img: '<img src="'+global_data.img+'/smiles/053.png">', bbcode:"+o("},
				{title: "(brb)", img: '<img src="'+global_data.img+'/smiles/066.gif">', bbcode:"(brb)"},
				{title: ":^)", img: '<img src="'+global_data.img+'/smiles/072.gif">', bbcode:":^)"},
				{title: "*-)", img: '<img src="'+global_data.img+'/smiles/073.gif">', bbcode:"*-)"},
				{title: "<o)", img: '<img src="'+global_data.img+'/smiles/075.gif">', bbcode:"<o)"},
				{title: "8-)", img: '<img src="'+global_data.img+'/smiles/076.gif">', bbcode:"|-)"},
				{title: "|-)", img: '<img src="'+global_data.img+'/smiles/078.gif">', bbcode:";-/"},
				{title: ";-/", img: '<img src="'+global_data.img+'/smiles/082.png">', bbcode:"(jk)"},
				{title: "(jk)", img: '<img src="'+global_data.img+'/smiles/084.png">', bbcode:"(j)"},
				{title: "(j)", img: '<img src="'+global_data.img+'/smiles/086.png">', bbcode:"(V)"},
				{title: "(V)", img: '<img src="'+global_data.img+'/smiles/087.png">', bbcode:"(lol)"},
				{title: "(lol)", img: '<img src="'+global_data.img+'/smiles/089.gif">', bbcode:"(xD)"},
				{title: "(xD)", img: '<img src="'+global_data.img+'/smiles/090.png">', bbcode:"(xD)"},
				{title: ":8)", img: '<img src="'+global_data.img+'/smiles/088.png">', bbcode:":8"},
				{title: "(ff)", img: '<img src="'+global_data.img+'/smiles/091.gif">', bbcode:"(ff)"},
				{title: "(fm)", img: '<img src="'+global_data.img+'/smiles/092.gif">', bbcode:"(fm)"},
				{title: ":'|", img: '<img src="'+global_data.img+'/smiles/093.gif">', bbcode:":'|"},
				{title: ":]", img: '<img src="'+global_data.img+'/smiles/094.gif">', bbcode:":]"},
				{title: ":}", img: '<img src="'+global_data.img+'/smiles/095.png">', bbcode:":}"},
				{title: "(BOO)", img: '<img src="'+global_data.img+'/smiles/096.png">', bbcode:"(BOO)"},
				{title: "*|", img: '<img src="'+global_data.img+'/smiles/097.gif">', bbcode:"*|"},
				{title: "*\\", img: '<img src="'+global_data.img+'/smiles/098.png">', bbcode:"*\\"},
				{title: "(wm)", img: '<img src="'+global_data.img+'/smiles/100.png">', bbcode:"(wm)"},
				{title: "(xo)", img: '<img src="'+global_data.img+'/smiles/101.gif">', bbcode:"(xo)"},
				{title: "(l)", img: '<img src="'+global_data.img+'/smiles/015.png">', bbcode:"(l)"},
				{title: "(u)", img: '<img src="'+global_data.img+'/smiles/016.png">', bbcode:"(u)"},
				{title: "(@)", img: '<img src="'+global_data.img+'/smiles/018.png">', bbcode:"(@)"},
				{title: "(&)", img: '<img src="'+global_data.img+'/smiles/019.png">', bbcode:"(&)"},
				{title: "(S)", img: '<img src="'+global_data.img+'/smiles/020.png">', bbcode:"(S)"},
				{title: "(*)", img: '<img src="'+global_data.img+'/smiles/021.png">', bbcode:"(*)"},
				{title: "(~)", img: '<img src="'+global_data.img+'/smiles/022.png">', bbcode:"(~)"},
				{title: "(8)", img: '<img src="'+global_data.img+'/smiles/023.png">', bbcode:"(8)"},
				{title: "(E)", img: '<img src="'+global_data.img+'/smiles/024.png">', bbcode:"(E)"},
				{title: "(F)", img: '<img src="'+global_data.img+'/smiles/025.png">', bbcode:"(F)"},
				{title: "(W)", img: '<img src="'+global_data.img+'/smiles/026.png">', bbcode:"(W)"},
				{title: "(O)", img: '<img src="'+global_data.img+'/smiles/027.gif">', bbcode:"(O)"},
				{title: "(K)", img: '<img src="'+global_data.img+'/smiles/028.png">', bbcode:"(K)"},
				{title: "(G)", img: '<img src="'+global_data.img+'/smiles/029.png">', bbcode:"(G)"},
				{title: "(^)", img: '<img src="'+global_data.img+'/smiles/030.png">', bbcode:"(^)"},
				{title: "(P)", img: '<img src="'+global_data.img+'/smiles/031.png">', bbcode:"(P)"},
				{title: "(I)", img: '<img src="'+global_data.img+'/smiles/032.png">', bbcode:"(I)"},
				{title: "(C)", img: '<img src="'+global_data.img+'/smiles/033.png">', bbcode:"(C)"},
				{title: "(T)", img: '<img src="'+global_data.img+'/smiles/034.png">', bbcode:"(T)"},
				{title: "({)", img: '<img src="'+global_data.img+'/smiles/035.png">', bbcode:"({)"},
				{title: "(})", img: '<img src="'+global_data.img+'/smiles/036.png">', bbcode:"(})"},
				{title: "(B)", img: '<img src="'+global_data.img+'/smiles/037.png">', bbcode:"(B)"},
				{title: "(D)", img: '<img src="'+global_data.img+'/smiles/038.png">', bbcode:"(D)"},
				{title: "(Z)", img: '<img src="'+global_data.img+'/smiles/039.png">', bbcode:"(Z)"},
				{title: "(X)", img: '<img src="'+global_data.img+'/smiles/040.png">', bbcode:"(X)"},
				{title: "(Y)", img: '<img src="'+global_data.img+'/smiles/041.png">', bbcode:"(Y)"},
				{title: "(N)", img: '<img src="'+global_data.img+'/smiles/042.png">', bbcode:"(N)"},
				{title: "(nnh)", img: '<img src="'+global_data.img+'/smiles/044.png">', bbcode:"(nnh)"},
				{title: "(#)", img: '<img src="'+global_data.img+'/smiles/046.png">', bbcode:"(#)"},
				{title: "(R)", img: '<img src="'+global_data.img+'/smiles/047.png">', bbcode:"(R)"},
				{title: "(sn)", img: '<img src="'+global_data.img+'/smiles/054.png">', bbcode:"(sn)"},
				{title: "(tu)", img: '<img src="'+global_data.img+'/smiles/055.png">', bbcode:"(tu)"},
				{title: "(pl)", img: '<img src="'+global_data.img+'/smiles/056.png">', bbcode:"(pl)"},
				{title: "(||)", img: '<img src="'+global_data.img+'/smiles/057.png">', bbcode:"(||)"},
				{title: "(pi)", img: '<img src="'+global_data.img+'/smiles/058.png">', bbcode:"(pi)"},
				{title: "(so)", img: '<img src="'+global_data.img+'/smiles/059.png">', bbcode:"(so)"},
				{title: "(au)", img: '<img src="'+global_data.img+'/smiles/060.png">', bbcode:"(au)"},
				{title: "(ap)", img: '<img src="'+global_data.img+'/smiles/061.png">', bbcode:"(ap)"},
				{title: "(um)", img: '<img src="'+global_data.img+'/smiles/062.png">', bbcode:"(um)"},
				{title: "(ip)", img: '<img src="'+global_data.img+'/smiles/063.png">', bbcode:"(ip)"},
				{title: "(co)", img: '<img src="'+global_data.img+'/smiles/064.png">', bbcode:"(co)"},
				{title: "(mp)", img: '<img src="'+global_data.img+'/smiles/065.png">', bbcode:"(mp)"},
				{title: "(st)", img: '<img src="'+global_data.img+'/smiles/067.png">', bbcode:"(st)"},
				{title: "(pu)", img: '<img src="'+global_data.img+'/smiles/102.png">', bbcode:"(pu)"},
				{title: "(yn)", img: '<img src="'+global_data.img+'/smiles/068.png">', bbcode:"(yn"},
				{title: "(h5)", img: '<img src="'+global_data.img+'/smiles/069.gif">', bbcode:"(h5)"},
				{title: "(mo)", img: '<img src="'+global_data.img+'/smiles/070.png">', bbcode:"(mo)"},
				{title: "(bah)", img: '<img src="'+global_data.img+'/smiles/071.png">', bbcode:"(bah)"},
				{title: "(li)", img: '<img src="'+global_data.img+'/smiles/074.gif">', bbcode:"(li)"},
				{title: "(wo)", img: '<img src="'+global_data.img+'/smiles/077.png">', bbcode:"(wo)"},
				{title: "'.'", img: '<img src="'+global_data.img+'/smiles/080.png">', bbcode:"'.'"},
				{title: "(bus)", img: '<img src="'+global_data.img+'/smiles/045.png">', bbcode:"(bus)"},
				{title: "*p*", img: '<img src="'+global_data.img+'/smiles/079.png">', bbcode:"*p*"},
				{title: "*s*", img: '<img src="'+global_data.img+'/smiles/085.png">', bbcode:"*s*"},
				{title: "(M)", img: '<img src="'+global_data.img+'/smiles/017.png">', bbcode:"(M)"},
				{title: "(xx)", img: '<img src="'+global_data.img+'/smiles/103.png">', bbcode:"(xx)"},
			],
