									...
									<tbody>
										...
										<tr id="foto_{$f.foto_id}">
											...
											<td class="admin_actions">
												<a href="{$tsConfig.url}/fotos/editar.php?id={$f.foto_id}" target="_blank"><img src="{$tsConfig.public}/images/icons/editar.svg" title="Editar Foto" /></a>
												...
												<a {if $f.f_status != 2}onclick="admin.fotos.setShowHide({$f.foto_id}); return false;"{/if}><img src="{$tsConfig.public}/images/icons/reactivar.svg" title="{if $f.f_status == 2}No disponible{else}Mostrar/Ocultar Foto{/if}" /></a>
											   	<a href="#" onclick="admin.fotos.borrar({$f.foto_id}); return false;"><img src="{$tsConfig.public}/images/icons/close.svg" title="Borrar Foto" /></a>
											</td>
										</tr>
										{/foreach}
									</tbody>
