                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="posts">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="report_{$r.obj_id}">
                                                ...
                                                <td class="admin_actions">
													<a href="#" onclick="mod.posts.borrar({$p.post_id}, 'posts'); return false"><img src="{$tsConfig.public}/images/icons/close.svg" title="Borrar Post" /></a>
                                                </td>
                                            </tr>
                                            {/foreach}{else}
                                            <tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="fotos">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="admin_actions">
														<a href="#" onclick="mod.fotos.borrar({$f.foto_id}); return false"><img src="{$tsConfig.public}/images/icons/close.svg" title="Borrar Foto" /></a>                                                </td>
                                            </tr>
                                            {/foreach}{else}
                                            <tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="p_comentarios">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="comentario_{$c.cid}">
                                                ...
                                                <td class="admin_actions">
                                                    <a href="#" onclick="ocultar_com({$c.cid}, {$c.user_id}); return false"><img src="{$tsConfig.public}/images/icons/reactivar.svg" title="Mostrar/Ocultar Comentario" /></a>
                                                </td>
                                            </tr>
                                            {/foreach}{else}
                                            <tr>
