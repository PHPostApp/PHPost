                                ...
                                <div id="res" class="boxy-content">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="report_{$r.obj_id}">
                                                ...
                                                <td class="admin_actions">
                                                    <a href="{$tsConfig.url}/moderacion/users?act=info&obj={$r.obj_id}"><img src="{$tsConfig.public}/images/icons/details.png" title="Ver Detalles" /></a>
                                                    <a href="{$tsConfig.url}/perfil/{$r.user_name}" target="_blank"><img src="{$tsConfig.public}/images/icons/user.png" title="Ver Perfil" /></a>
                                                    <a href="#" onclick="mod.users.action({$r.obj_id}, 'aviso', false); return false;"><img src="{$tsConfig.public}/images/icons/warning.png" title="Enviar Alerta" /></a>
                                                    {if $tsUser->is_admod || $tsUser->permisos.mosu}<a href="#" onclick="mod.users.action({$r.obj_id}, 'ban', false); return false;"><img src="{$tsConfig.public}/images/icons/power_off.png" title="Suspender Usuario" /></a>{/if}
                                                    {if $tsUser->is_admod || $tsUser->permisos.modu}<a href="#" onclick="mod.reboot({$r.obj_id}, 'users', 'reboot', false); return false"><img src="{$tsConfig.public}/images/icons/close.svg" title="Cancelar denuncias" /></a>{/if}
                                                </td>
                                            </tr>
                                            {/foreach}{else}
                                            <tr>
                                    ...
                                    <h2 style="border-bottom:1px dashed #CCC; padding-bottom:5px;">
                                        ...
                                        <span class="floatR admin_actions">
                                            ...
                                            <a href="#" onclick="mod.reboot({$tsDenuncia.data.user_id}, 'users', 'reboot', true); return false"><img src="{$tsConfig.public}/images/icons/close.svg" title="Cancelar denuncias" /></a>
                                        </span>
                                    </h2>
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center">
                                    	<thead>
