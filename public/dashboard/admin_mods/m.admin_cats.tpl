...
<div id="res" class="boxy-content">
			...
			<tbody id="cats_orden">
				...
				<tr id="{$c.cid}" data-id="{$c.cid}">
					...
					<td class="admin_actions" width="100">
						<a href="{$tsConfig.url}/admin/cats?act=editar&cid={$c.cid}&t=cat"><img src="{$tsConfig.public}/images/icons/editar.svg" title="Editar Categor&iacute;a"/></a>
						<a href="{$tsConfig.url}/admin/cats?act=borrar&cid={$c.cid}&t=cat"><img src="{$tsConfig.public}/images/icons/close.svg" title="Borrar Categor&iacute;a"/></a>
					</td>
				</tr>
				{/foreach}
			</tbody>
	...
	{elseif $tsAct == 'editar'}
	 ...
	 {elseif $tsAct == 'nueva'}
		  <div class="alert alert-danger">Si deseas m&aacute;s iconos para las categor&iacute;as debes subirlos al directorio: {$tsConfig.public}/images/icons/cat/</div>
		  <form action="" method="post" autocomplete="off">
		  <fieldset>
				<legend>Nueva</legend>
				<dl>
