				...
				<tbody>
					...
					<tr id="few_{$af.aid}">
						...
						<td class="admin_actions">
							<a href="{$tsConfig.url}/admin/afs?act=editar&aid={$af.aid}"><img src="{$tsConfig.public}/images/icons/editar.svg" title="Editar"/></a>
							...
							<a onclick="admin.afs.accion({$af.aid}); return false"><img src="{$tsConfig.public}/images/icons/reactivar.svg" title="Activar/Desactivar Afiliado" /></a>
							<a href="#" onclick="admin.afs.borrar({$af.aid}); return false"><img src="{$tsConfig.public}/images/icons/close.svg" title="Eliminar"/></a>
						</td>
					</tr>
					{/foreach}
				</tbody>
