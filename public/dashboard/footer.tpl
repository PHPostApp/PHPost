		...
		<footer class="d-flex flex-wrap justify-content-between align-items-center px-3 border-top">
	    	...
	    	<ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
	     		<li class="ms-3"><a class="fs-4" title="PHPost '23" href="https://discord.gg/mx25MxAwRe" target="_blank"><iconify-icon icon="logos:discord-icon"></iconify-icon></a></li>
	      	<li class="ms-3"><a class="fs-4" title="PHPost '23" href="https://t.me/PHPost23" target="_blank"><iconify-icon icon="logos:telegram"></iconify-icon></a></li>
	    	</ul>
	  </footer>
	</main>
