<div class="com_new_box">
    ...
    <div class="clearfix">
        <form action="{$tsConfig.url}/comunidades/buscar/">
			...
			<input type="hidden" name="comid" value="{$tsComunidades.c_id}" />
        </form>
    </div>
</div>
...
<div class="com_new_box">
    ...
    <div class="com_box_title clearfix"><div class="cbt_right"><a href="{$tsConfig.url}/comunidades/{$tsComunidades.c_nombre_corto}/miembros/">Ver m&aacute;s &raquo;</a></div></div>
</div>
        ...
        <div id="com_change_pop">
            <div id="ccp_semana" style="display: block;">
                ...
                <div class="com_list_element" {if $t.t_estado == 1}style="opacity: 0.5;background: #000;" title="El tema ha sido eliminado"{/if}>
                    ...
                    <a href="{$tsConfig.url}/comunidades/{$tsComunidades.c_nombre_corto}/{$t.t_id}/{$t.t_titulo|seo}">{$t.t_titulo|truncate:30}</a>
...
<small><i class="com_icon icon_denuncia" style="vertical-align:top;margin-right:1px;opacity: 0.5;"></i><a href="#" onclick="denuncia.nueva('comunidad',{$tsComunidades.c_id}, '{$tsComunidades.c_nombre}', ''); return false;">Denunciar Comunidad</a> - <a href="{$tsConfig.url}/comunidades/{$tsComunidades.c_nombre_corto}/mod-history/">Historial</a></small>