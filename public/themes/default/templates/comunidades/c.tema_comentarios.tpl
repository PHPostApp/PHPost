<div class="com_tema_comentarios clearfix">
	<div class="com_box_title clearfix"><h2><span id="cbt_val">{$tsTema.t_respuestas|kmg}</span> comentarios</h2></div>
    ...
    <div id="result_answers">{include file='t.php_files/c.pages_respuestas.tpl'}</div> 
    
    {if $tsUser->is_member && $tsComunidades.es_miembro || $tsComunidades.mi_rango >= 3 || $tsUser->is_admod}
