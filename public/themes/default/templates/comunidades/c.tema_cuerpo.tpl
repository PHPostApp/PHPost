...
<div class="com_tema_share clearfix">
	<ul class="cts_buttons">
    	...
    	<li class="ctsb_web">									 	
            <span class="share-t-count">{$tsTema.t_share|kmg}</span>            
...
<div class="com_tema_options clearfix">
    ...
    <ul class="cts_stats clearfix floatR">
    	<li>
        	<span id="favs_total">{$tsTema.t_favoritos|kmg}</span><i class="com_icon icon_favs"></i>
            <div>Favoritos</div>
        </li>
        <li>
        	<span>{$tsTema.t_visitas|kmg}</span><i class="com_icon icon_visitas"></i>
            <div>Visitas</div>
        </li>
        <li>
        	<span id="segs_total">{$tsTema.t_seguidores|kmg}</span><i class="com_icon icon_eye"></i>
            <div>Seguidores</div>
        </li>
        <li>
        	<span id="votos_total" style="color:{if $tsTema.t_votos_pos-$tsTema.t_votos_neg > 0}green{elseif $tsTema.t_votos_pos-$tsTema.t_votos_neg < 0}red{else}#222{/if}">{$tsTema.t_votos_pos-$tsTema.t_votos_neg|kmg}</span><i class="com_icon icon_like"></i>
