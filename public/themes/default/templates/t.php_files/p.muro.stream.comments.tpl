...
<li class="ufiItem" id="cmt_{$c.cid}">
    <div class="clearfix">
        ...
        {if $tsComentarios.user == $tsUser->uid || $c.c_user == $tsUser->uid}<span class="close"><a href="#" onclick="muro.del_pub({$c.cid}, 2); return false" class="uiClose" title="Eliminar"></a></span>{/if}
        <div class="mensaje">
