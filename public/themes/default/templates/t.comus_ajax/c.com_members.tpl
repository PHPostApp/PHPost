{if $tsMiembros.total > 0}
	{if $tsMiembros.type == 'miembros'}
        ...
        <div class="com_list_members clearfix">
            ...
            <ul class="clm_info clearfix floatL">
                ...
                {if $tsComunidades.mi_rango == 5 && $a.m_user != $tsUser->uid || $tsUser->is_admod && $a.m_user != $tsUser->uid}
    ...
    {elseif $tsMiembros.type == 'suspendidos'}
        ...
        <div class="com_list_members clearfix">
            ...
            <ul class="clm_info clearfix floatL">
                ...
                <li><a onclick="mensaje.nuevo('{$a.user_name}','','',''); return false">Enviar mensaje</a></li>
                {if $tsComunidades.mi_rango == 5 || $tsUser->is_admod}
    ...
    <div class="com_pagination clearfix">
        {if $tsMiembros.pages.prev}<a class="cp_prev" href="{$tsConfig.url}/comunidades/{$tsComunidades.c_nombre_corto}/miembros.{$tsMiembros.pages.prev}/"></a>{/if}
        {if $tsMiembros.pages.pages > 1 && $tsMiembros.pages.pages > $tsMiembros.pages.current}<a class="cp_next" href="{$tsConfig.url}/comunidades/{$tsComunidades.c_nombre_corto}/miembros.{$tsMiembros.pages.next}/"></a>{/if}
    </div>
    {/if}
{else}
