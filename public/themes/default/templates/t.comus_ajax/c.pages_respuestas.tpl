...
<div class="ctc_coment_list">
    ...
    <div class="com_coment_resp clearfix" id="coment_id_{$r.r_id}">
        ...
        <ul class="ccr_options clearfix">
            ...
            {if $tsComunidades.es_miembro && $tsTema.t_cerrado == 0 && $tsComunidades.mi_rango >= 2 || $tsComunidades.mi_rango >= 4 || $tsUser->is_admod || $tsUser->uid == $tsTema.t_autor}
            ...
            {/if}       
            {if $r.r_autor == $tsUser->uid || $tsUser->is_admod || $tsComunidades.mi_rango >= 4}
            <li><a href="javascript:com.del_respuesta({$r.r_id});return false;" class="qtip" title="Borrar comentario"><i class="com_icon icon_del"></i></a></li>
            {/if}
        </ul>
        {/if}
