                        	{if $tsComentarios.num > 0}
                        	
							{foreach from=$tsComentarios.data item=c}
								...
								<div class="comentario-post clearbeta">
									...
									<div class="avatar-box" style="z-index: 99;">
										...
										<ul style="display: none;">
											...
											<li class="bloquear {if $tsComentarios.block}des{/if}bloquear_1"><a href="javascript:bloquear({$c.c_user}, {if $tsComentarios.block}false{else}true{/if}, 'comentarios')">{if $tsComentarios.block}Desbloquear{else}Bloquear{/if}</a></li>
